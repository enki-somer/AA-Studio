...
export default function JumpEffectDemo() {
    ...
    <div className="my-6">
      ...
      <div className="flex items-center justify-center gap-2 mb-6">
        <button
          ...
          className={`px-4 py-2 text-xs md:text-sm font-medium rounded-lg transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 ${
            view === 'before'
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            >
              ...
              <rect width="400" height="300" fill="url(#grid-jump)" />
